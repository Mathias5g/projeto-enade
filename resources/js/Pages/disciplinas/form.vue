            ...
            <div class="max-w-7xl h-full mx-auto sm:px-6 lg:px-8">
                <div class="bg-white h-full overflow-auto shadow-xl sm:rounded-lg">
                    ...
                    <form @submit.prevent="formSubmit" class="flex flex-col p-4 h-full justify-between">
                        <div>
                            <div v-show="typeof disciplina != 'undefined'" class="flex items-center justify-between w-full my-1">
                        ...
                        <div class="flex justify-end">
                            ...
                            <Link href="/disciplinas"><button type="button" class="w-40 p-1 bg-red-600 text-white font-semibold">Cancelar</button></Link>
                        </div>
                    </form>
                </div>
            </div>
